...
namespace Compatibility.Demo
{

    public class CompatibilityDemoCommandBuild : MonoBehaviour
    {

        public const string buildPath = "CompatibilityDemo";


        private static string[] GetAllScenes()
        {

            string rootScene = "DemoScene.unity";




            List<string> scenesList = new List<string>();
            scenesList.Add("Assets/CompatibilityDemo/" + rootScene);
            ...
            for (int i = 0; i < resFiles.Length; i++)
            {
                ...
                if (resFiles[i] != "Assets/CompatibilityDemo/" + rootScene)
                {
